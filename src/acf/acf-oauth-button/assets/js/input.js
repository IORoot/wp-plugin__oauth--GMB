(function($){
	...
	*/
	...
	function initialize_field( $field ) {
		...
		var $button = $field.find('.andyp-oauth__button-gmb');
		var $trash  = $field.find('.andyp-oauth__button-gmb--trash');
	...
	function oauth_do_request($button, $trash) {
		var $win = window.open( gmb_oauth.auth_url, "_blank", "width=600,height=600" );
	...
	*/
	if( typeof acf.add_action !== 'undefined' ) {
		acf.add_action('ready_field/type=oAuthGMB', initialize_field);
		acf.add_action('append_field/type=oAuthGMB', initialize_field);
